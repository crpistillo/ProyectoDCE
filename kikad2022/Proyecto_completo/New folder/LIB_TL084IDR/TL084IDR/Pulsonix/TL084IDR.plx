...
//9763/744555/2.49/14/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TL084IDR" (originalName "TL084IDR")
	...
	(compDef "TL084IDR" (originalName "TL084IDR") (compHeader (numPins 14) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TL084IDR"))
		...
		(attr "Manufacturer_Part_Number" "TL084IDR")
		(attr "Mouser Part Number" "595-TL084IDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TL084IDR?qs=UGVLDq%2F29uhRaWn16yu8Iw%3D%3D")
		(attr "Arrow Part Number" "TL084IDR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tl084idr/texas-instruments?region=nac")
		(attr "Description" "Quad High Slew Rate JFET-Input Operational Amplifier")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tl082.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TL084IDR.stp")
