...
(library Library_1
	...
	(symbolDef "IRF630" (originalName "IRF630")
	...
	(compDef "IRF630" (originalName "IRF630") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IRF630"))
		...
		(attr "Manufacturer_Part_Number" "IRF630")
		(attr "Arrow Part Number" "IRF630")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/irf630/stmicroelectronics")
		(attr "Mouser Part Number" "511-IRF630")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/IRF630?qs=VREXnN%2FAp%252BsoyJB%252BEIl5Bw%3D%3D")
		(attr "Description" "IRF630, N-channel MOSFET Transistor 9 A 200 V, 3-Pin TO-220")
		(attr "<Hyperlink>" "https://www.st.com/resource/en/datasheet/cd00000701.pdf")
		(attr "<Component Height>" "4.6")
		(attr "<STEP Filename>" "IRF630.stp")
