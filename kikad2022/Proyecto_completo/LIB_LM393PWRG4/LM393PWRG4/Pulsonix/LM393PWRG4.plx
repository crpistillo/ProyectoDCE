...
//909693/744555/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM393PWRG4" (originalName "LM393PWRG4")
	...
	(compDef "LM393PWRG4" (originalName "LM393PWRG4") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM393PWRG4"))
		...
		(attr "Manufacturer_Part_Number" "LM393PWRG4")
		(attr "Mouser Part Number" "595-LM393PWRG4")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM393PWRG4?qs=VBduBm9rCJQGUzM7kHR1Qw%3D%3D")
		(attr "Arrow Part Number" "LM393PWRG4")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lm393pwrg4/texas-instruments")
		(attr "Description" "Dual differential comparator, commercial grade")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/LM393")
		(attr "<Component Height>" "1.2")
		(attr "<STEP Filename>" "LM393PWRG4.stp")
